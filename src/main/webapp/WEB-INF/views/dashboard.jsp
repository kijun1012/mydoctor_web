			...
			<div class="col-md-6">
				...
				<div class="box box-success direct-chat direct-chat-success">
					<div class="box-header with-border">
						<h3 class="box-title">담당의사 조언</h3>


					</div>
					<!-- /.box-header -->
					<div class="box-body" style="height: 255px;">
              ...
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-primary">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse" aria-expanded="true" style="height: 0px;">
                    <div class="box-body">
                    	 <h4><b>My Doctor의 오신 것을 환영합니다.</b></h4></br>
                    	1. 먼저 안드로이드 App <b>MyDoctor</b>를 설치하십시오.</br>
                    	2. App으로 측정한 당신의 Data에 따른 서비스를 이곳에서 체험 할 수 있습니다.</br>
                    	3. 당신의 건강 Data를 확인하고 건강 관리를 시작하십시오.</br>
                    	4. <b>데이터 분석결과</b>와 <b>위험 지수</b>를 확인하세요!!</br>
                    	5. 당신의 더 나은 건강 관리를 위해 <b>담당 의사</b>를 선택하세요!! 
                    </div>
                  </div>
                </div>
                <div class="panel box box-danger">
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse" aria-expanded="true">
                    <div class="box-body">
                      	<b>당신의 건강 Data의 따라서 위험지수와 데이터 분석결과가 일치하지 않을 수 있습니다.</b></br></br>
                      	위험지수는 단순한 건강지표별 계산법에 따른 경고입니다.</br>
                      	하지만 데이터 분석 결과는 건강보험공단에서 제공하는 표본Data </br>
                      	<b>'2013~2014년 일반검진 및 생애전환기 건강검진 데이터 19,451,956건'</b>을 이용하여 만들어진 기계 학습 모델을 통해 정확도 92%정도로 예측된 결과입니다.
                      	</br></br>
                      	데이터 분석은 당신의 <b>나이, 성별, 수축기혈압, 이완기혈압, 혈당, BMI지수</b> 지표를 이용하여 분석됩니다. 
                      	만약 당신의 건강의 대하여 위험지수나 데이터 분석결과가 위험하다고 알리고 있다면 꼭 담당 의사와 상담 하기를 바랍니다. 
								...
								<div class="direct-chat-msg">
									...
									<c:if test="${analysisData.dis == '1' }">
										<div class="direct-chat-text">
											<p class="text-red"><b>데이터 분석 결과 당신은 고혈압과 당뇨가 의심됩니다. 혈압과,혈당 모두 관리가 필요합니다.</br>담당의사와
											상담하세요.</b></p>
										</div>
									</c:if>
									<c:if test="${analysisData.dis == '2' }">
										<div class="direct-chat-text">
											<p class="text-yellow"><b>데이터 분석 결과 당신은 고혈압이 의심됩니다. 혈압관리가 필요합니다.</br>담당의사와 상담하세요.</b></p>
										</div>
									</c:if>
									<c:if test="${analysisData.dis == '3' }">
										<div class="direct-chat-text">
											<p class="text-yellow"><b>데이터 분석 결과 당신은 당뇨가 의심됩니다. 혈당관리가 필요합니다.</br>담당의사와 상담하세요.</b></p>
										</div>
									</c:if>
									<c:if test="${analysisData.dis == '4' }">
										<div class="direct-chat-text"><p class="text-green"><b>데이터 분석 결과 당신은 건강합니다.</b></p></div>
									</c:if>
