						...
						<div class="box-group" id="accordion">
							...
							<div class="panel box box-danger">
								<div class="box-header with-border">
									<h4 class="box-title">
										<a data-toggle="collapse" data-parent="#accordion"
											href="#collapseThree" class="" aria-expanded="true">고혈압에 대하여</a>
									</h4>
								</div>
								<div id="collapseThree" class="panel-collapse collapse"
									aria-expanded="true">
									<div class="box-body">
										운동 능력이 많은 사람의 경우 수축기 혈압과 이완기 혈압 모두 평균보다 낮은 것으로 알려져 있습니다.
										체중과 키, 연령을 추가하여 비교할 때에도 운동능력이 평균보다 높은 사람들이 평균혈압보다 낮게 나타납니다.</br>
										8년간 추적연구결과 운동하는 사람이 안 하는 사람보다 고혈압 발생 위험이 <b>52%</b>나 낮게 나타났다는 보고도 있습니다.</br>
										</br>
										<b>경증(1기) 고혈압</b>에서 효과가 가장크며, <b>2기 고혈압</b>에서도 어느 정도 효과가 있습니다.</br> 
										하지만 <b>3기 중증 고혈압</b>에서는 운동과 혈압의 영향에 대한 자료가 거의 없으며,
										실제로도 혈압 감소 효과는 거의 없는 것으로 추측됩니다.</br>
										</br>
										일반적으로 <b>고혈압 환자</b>들에게는 우리 몸 전체의 관절과 근육들을 상당시간 동안 움직이는 <b>유산소 운동이 좋습니다.</b>
										걷기, 조깅, 자전거타기, 수영, 체조, 줄넘기 등이 유산소 운동에 속합니다. 하지만 무거운 것을 드는 운동은
										일시적으로 혈압을 상승 시킬 수 있기 때문에 주의해야 합니다.
										</br>
										</br>
										<b>운동을 시작하여 혈압을 낮추고 심폐기능을 개선하여 체중을 낮추세요!!</b></br>
										<b>혈중 콜레스테롤 수치</b>를 개선하고 <b>스트레스 해소</b> 등을 통해 고혈압 환자에게 매우 효과적입니다!! <b>일주일 3~5회</b> 정도 규칙적인 운동을 하여
										처음 운동을 할 때에는 <b>10~20분</b> 정도로 천천히 운동량을 늘려서 <b>30~50회</b> 정도 실시하는 것이 적당합니다.
										</br>
										</br>
										<b>하지만 자신의 몸상태에 맞는 운동을 하는 것이 중요하기 때문에 담당의사와 상담하세요!!</b> 
							...
							<div class="panel box box-danger">
								<div class="box-header with-border">
									<h4 class="box-title">
										<a data-toggle="collapse" data-parent="#accordion"
											href="#collapseFour" class="" aria-expanded="true">당뇨에 대하여</a>
									</h4>
								</div>
								<div id="collapseFour" class="panel-collapse collapse"
									...
									<div class="box-body">
										...
										저항성을 개선하고 체중을 조절하면 <b>혈당을 낮추는데 많은 도움이 됩니다.</b>
										<br/>
										<br/>
										<b>일주일에 4회 이상</b> 규칙적으로 운동하는 당뇨 환자는 약 30%에 불과합니다. 운동을 하면 <b>혈당관리</b>뿐만 아니라
										<b>당뇨병성 합병증</b>을 유발하는 여러 위험요인들을 개선시킵니다. 그러므로 의사와 상담에서 특별한 금기사항이 없는 한
										규칙적인 운동이 반드시 병행되어야 합니다.
										<br/>
										<br/>
										<b>당뇨인에게 운동은 선택이 아니라 필수입니다!!</b>
								...
								<div class="direct-chat-msg">
									...
									<c:if test="${analysisData.dis == '1' }">
										<div class="direct-chat-text">
											<p class="text-red">
												<b>데이터 분석 결과 당신은 고혈압과 당뇨가 의심됩니다.</br> 혈압과,혈당 모두 관리가 필요합니다.</br>
												왼쪽 하단에 참고사항을 확인해주세요</br>담당의사와 상담하세요.
												</b>
											</p>
										</div>
										<c:if test="${SCpoint == '1'}">
											<div class="direct-chat-text">
												<p class="text-yellow">
													<b>고혈압과 당뇨 같은 만성질환에는 걷기운동 같은 유산소운동이 좋습니다.</br> 하지만 당신은 하루에 5000보 이하로 너무
										...
										<c:if test="${SCpoint == '2'}">
											<div class="direct-chat-text">
												<p class="text-yellow">
													<b>고혈압과 당뇨 같은 만성질환에는 걷기운동 같은 유산소운동이 좋습니다.</br> 당신은 활동적이네요. </br> 지금처럼 꾸준히
										...
										<c:if test="${SCpoint == '4'}">
											<div class="direct-chat-text">
												<p class="text-green">
													<b>고혈압과 당뇨 같은 만성질환에는 걷기운동 같은 유산소운동이 좋습니다. </br>당신은 매우 활동적이군요. </br>만약에 몸에
														무리가 있다면 운동 또는 걷기의 강도를 조금 낮추는 것이 좋습니다.</b>
												</p>
											</div>
										</c:if>
									...
									<c:if test="${analysisData.dis == '2' }">
										<div class="direct-chat-text">
											<p class="text-yellow">
												<b>데이터 분석 결과 당신은 고혈압이 의심됩니다. 혈압관리가 필요합니다.</br>
												왼쪽 하단에 참고사항을 확인해주세요</br>담당의사와 상담하세요.
												</b>
											</p>
										</div>
									...
									<c:if test="${analysisData.dis == '3' }">
										<div class="direct-chat-text">
											<p class="text-yellow">
												<b>데이터 분석 결과 당신은 당뇨가 의심됩니다. 혈당관리가 필요합니다.</br>
												왼쪽 하단에 참고사항을 확인해주세요</br>담당의사와 상담하세요.
												</b>
											</p>
										</div>
